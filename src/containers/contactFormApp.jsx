...
class ContactFromApp extends React.Component {
  ...
  handlerSubmit(e) {
    if (
      this.props.nameField.valid &&
      this.props.nameField.text &&
      this.props.emailField.valid &&
      this.props.emailField.text &&
      this.props.messageField.valid &&
      this.props.messageField.text
    ) {
  ...
  render() {
    return (
      ...
      >
        <span
          className='error'
          style={{ display: this.props.nameField.valid ? 'none' : '' }}
        >
        ...
        <span
          className='error'
          style={{ display: this.props.emailField.valid ? 'none' : '' }}
        >
        ...
        <input
          type='text'
          name='email'
          value={this.props.emailField.text}
          placeholder='Email'
        />
        <span
          className='error'
          style={{ display: this.props.messageField.valid ? 'none' : '' }}
        >
        ...
        <textarea
          className='message'
          name='message'
          value={this.props.messageField.text}
          placeholder='Message'
        />
